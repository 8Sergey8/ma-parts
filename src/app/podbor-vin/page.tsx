  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-3 max-w-3xl text-[#2c4a66]">
        Введите 17-значный VIN — определим марку и кузов и покажем оригинальные
        позиции со склада MBA-parts, которые подходят этому автомобилю. Нет в
        наличии — оставьте заявку, привезём из Европы по каталогу производителя.
      </p>
          ...
          <section className="rounded-2xl border border-[#d5e6f3] bg-white p-6">
            ...
            <p className="mt-3 text-sm text-[#2c4a66]">
              {result.match === "chassis"
                ? "Ниже — оригинальные детали со склада, у которых совпал код кузова или модели."
                : "Точный кузов по VIN не совпал с карточками склада. Показаны оригинальные позиции этой марки — менеджер сверит применимость по каталогу производителя."}
            </p>
          </section>
          ...
          <section>
            <div className="mb-4 flex items-end justify-between gap-4">
              <h2 className="text-xl font-bold text-[#16324f]">
                Подходящие запчасти: {result.parts.length}
              </h2>
              <Link
            ...
            {result.parts.length === 0 ? (
              <p className="rounded-xl border border-[#d5e6f3] bg-white p-6 text-sm text-[#5a7a96]">
                На складе нет карточек под этот VIN. Оставьте заявку ниже — подберём
                оригинал по каталогу и привезём из Европы.
              </p>
            ) : (
        ...
        <section className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              text: "Показываем оригинальные позиции, которые подходят этому автомобилю.",
            },
            {
              title: "3. Европа",
