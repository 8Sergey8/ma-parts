  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-3 max-w-3xl text-[#2c4a66]">
        Введите 17-значный VIN. Определим марку, модель и год и покажем
        оригинальные запчасти под ваш автомобиль.
      </p>
          ...
          <section className="rounded-2xl border border-[#d5e6f3] bg-white p-6">
            ...
            <p className="mt-3 text-sm text-[#2c4a66]">
              {result.match === "chassis"
                ? "Сначала позиции, у которых совпал кузов. Ниже — остальные детали этой марки."
                : "По VIN определена марка. Показаны оригинальные запчасти этой марки. Менеджер сверит точный номер по VIN."}
            </p>
          </section>
          ...
          <section>
            ...
            {result.parts.length === 0 ? (
              <p className="rounded-xl border border-[#d5e6f3] bg-white p-6 text-sm text-[#5a7a96]">
                По этой марке сейчас нет позиций в наличии. Оставьте заявку ниже — подберём и привезём.
              </p>
            ) : (
      ...
      {!result && (
        <section className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            {
              title: "2. Подбор",
              text: "Показываем оригинальные запчасти под марку вашего автомобиля. Нет в наличии — оформите заявку, привезём.",
            },
            {
              title: "3. Европа",
