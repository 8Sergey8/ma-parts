...
const services = [
  ...
  },
  {
    ...
    text: "Самовывоз: Москва, ул. Кедрова, 13к2 — если позиция в магазине. С центрального склада 1–3 дня, с удалённого 5–7 дней. По России — транспортными компаниями.",
  },
  {
    icon: Plane,
    title: "Заказ запчастей из Европы",
    text: "Если позиции нет в России, оформляем поставку с европейских складов официальных дилеров. Срок 14–25 дней, с проверкой оригинальности на приёмке.",
  },
];
